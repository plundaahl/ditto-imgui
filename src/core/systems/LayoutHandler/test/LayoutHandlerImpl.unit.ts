...
import { LayoutFunction, LayoutHandler } from '../LayoutHandler';
import { LayoutHandlerImpl } from '../LayoutHandlerImpl';

let defaultLayoutFn: LayoutFunction;
let instance: LayoutHandler;
let defaultLayer: Layer;

beforeEach(() => {
    defaultLayer = createLayer();
    defaultLayoutFn = jest.fn();
    instance = new LayoutHandlerImpl(defaultLayoutFn);
});
